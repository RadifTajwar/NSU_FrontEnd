...
exports.voiceGenerate = catchAsyncError(async (req, res, next) => {
    ...
    const directory = `../LatestFrontend/public/story/user/${storyTitle}/speeches`;
    
    const filePath = `../LatestFrontend/public/story/user/${storyTitle}/lines`;
...
exports.imageGenerate = catchAsyncError(async (req, res, next) => {
    ...
    //     const directory = `../LatestFrontend/public/story/user/${storyTitle}/images`;
